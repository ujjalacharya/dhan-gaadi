		...
		return (
			<div style={styles.wrapper}>
				<div style={styles.busDiv}>
						...
						return (
							<div key={i}>
								<button
									...
									size={size}
									disabled={sold.includes(oddA[i]) ? true : booked.includes(oddA[i]) ? true : false}
									style={
								...
								<button
									className="btn btn-sm btn-primary"
									size={size}
									disabled={sold.includes(evenA[i]) ? true : booked.includes(evenA[i]) ? true : false}
									style={
					...
					{arr.map((le, i) => (
						<div key={i} style={{ ...styles.secondCol, ...{ top: `${le}rem` } }}>
							<button
								className="btn btn-sm btn-primary"
								disabled={sold.includes(oddB[i]) ? true : booked.includes(oddB[i]) ? true : false}
								size={size}
								style={
							...
							<button
								className="btn btn-sm btn-primary"
								disabled={sold.includes(evenB[i]) ? true : booked.includes(evenB[i]) ? true : false}
								size={size}
								style={
