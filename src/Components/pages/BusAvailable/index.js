...
class BusAvailable extends Component {
	...
	fetchAvailableBuses = async () => {
		const buses = await getAvailableBusesOfOwner();
		buses.data.map(bus => {
			bus.date = moment(bus.createdAt).format("MMMM Do, YYYY")
		})
		this.setState({buses: buses.data})
	};
										...
										<div className="d-flex" id="wrapper">
														<div id="page-content-wrapper">
																		<div className="container-fluid">
																						...
																						<button className="btn btn-outline-primary float-right mt-3 mr-2" data-toggle="modal" data-target="#add-user-modal"> Add User</button>
